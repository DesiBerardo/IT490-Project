...
background:
    ...
    url(https://github.com/CodeJirachi/IT490_Project/blob/Final/neam.png);
</style>
</head>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="#">NEAM</a>
    ...
    <li class="nav-item active">
    <a class="nav-link" href="library.php">Games Library</a>
    </li>
    <li class="nav-item active">
    <a class="nav-link" href="search_page.php">Search Games</a>
    </li>
    <li class="nav-item active">
